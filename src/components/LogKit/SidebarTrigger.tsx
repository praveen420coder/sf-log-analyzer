...
const SidebarTrigger: React.FC<{ onClick: () => void }> = ({ onClick }) => (
  <button
    onClick={onClick}
    className="fixed right-0 top-1/2 -translate-y-1/2 z-50 bg-black opacity-40 hover:opacity-100 transition-all flex flex-col items-center justify-center w-7 h-20 rounded-l-2xl group border-y border-l border-white/20"
  >
