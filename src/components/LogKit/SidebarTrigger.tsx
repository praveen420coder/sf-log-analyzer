...
const SidebarTrigger: React.FC<{ onClick: () => void }> = ({ onClick }) => (
  <button
    onClick={onClick}
    className="fixed right-0 top-1/2 -translate-y-1/2 z-50 bg-black hover:bg-zinc-800 transition-all flex flex-col items-center justify-center w-12 h-32 rounded-l-2xl shadow-[-10px_0_30px_rgba(0,0,0,0.2)] group border-y border-l border-white/20"
  >
